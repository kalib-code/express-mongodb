...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Taya.Medhurst4',
      password: '_5wedol_utSoJ9M',
      email: 'Guillermo.Stroman17@gmail.com',
      name: 'Regina Friesen',
      shippingAddress: [
        {
          _id: false,
      ...
      userType: 301,
      mobileNo: '(913) 319-8051',
      resetPasswordLink: {},
      loginRetryLimit: 526,
      loginReactiveTime: '2023-05-25T05:32:44.579Z',
      ssoAuth: {
        googleId: 'orange',
        facebookId: 'Advanced' 
      },
      id: '62e3ede3be4d3271f49af53d'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Luciano.Littel32',
        'password':'YE3Zn7jSGZ9D4L3',
        'email':'Joy_Oberbrunner@gmail.com',
        'name':'Marilyn Schaefer',
        'shippingAddress':[{
          '_id':false,
          'pincode':'models',
          'address1':'Buckinghamshire',
          'address2':'Small',
          'landmark':'Sports',
          'city':'driver',
          'isDefault':true,
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Joy_Oberbrunner@gmail.com', });
