...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Name.Ziemann85',
      password: 'vMDDf3LDj_e0s2_',
      email: 'Dustin.VonRueden@yahoo.com',
      name: 'Erika Swift',
      shippingAddress: [
        {
          _id: false,
      ...
      userType: 91,
      mobileNo: '(335) 994-0463',
      resetPasswordLink: {},
      loginRetryLimit: 858,
      loginReactiveTime: '2023-02-21T10:46:15.677Z',
      ssoAuth: {
        googleId: 'Ergonomic',
        facebookId: 'Uruguayo' 
      },
      id: '62e3ede3be4d3271f49af5b5'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Lorenz.Cormier',
        'password':'73xsqvxsskRzSET',
        'email':'Magdalena.Haag41@hotmail.com',
        'name':'Ralph Padberg',
        'shippingAddress':[{
          '_id':false,
          'pincode':'Planner',
        ...
        'mobileNo':'(735) 365-5500',
        'ssoAuth':{
          'googleId':'Wyoming',
          'facebookId':'withdrawal'
        },
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/client/auth/forgot-password')
      .send({ 'email':'Magdalena.Haag41@hotmail.com', });
